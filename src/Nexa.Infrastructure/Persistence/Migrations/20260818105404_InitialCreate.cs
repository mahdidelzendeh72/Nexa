        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_model_profiles_model_providers_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Instructions = table.Column<string>(type: "character varying(32000)", maxLength: 32000, nullable: false),
                    ModelProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                    MaxDurationSeconds = table.Column<int>(type: "integer", nullable: true),
                    MaxToolCalls = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_agent_versions_model_profiles_ModelProfileId",
                        column: x => x.ModelProfileId,
                        principalTable: "model_profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_conversations_agent_versions_AgentVersionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_agent_versions_AgentId_VersionNumber",
                table: "agent_versions",
                columns: new[] { "AgentId", "VersionNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_agent_versions_ModelProfileId",
                table: "agent_versions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_conversations_AgentVersionId",
                table: "conversations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_model_profiles_ProviderId",
                table: "model_profiles",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_model_providers_Name",
